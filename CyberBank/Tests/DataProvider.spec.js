...
//run this in terminal, it helps to rather than creating 3 specs, it does in one spec no need for loop
...
describe('Jasmine Data Provider ', () => {
    ...
    using(dataProvider, function(data){
        it('should add customer: '+data.fName+' '+data.lName, () => { 
            //making it dynamic as the it specs run array.length above           
